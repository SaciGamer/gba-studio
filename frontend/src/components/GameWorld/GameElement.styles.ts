...
export const elementStyle = (transform: Transform | null, background: string, width: number, height: number, x: number, y: number, isSelected: boolean, tokenAntD): CSSProperties => {
  return {
...
export const titleStyle: (isSelected: boolean, isHovered: boolean, tokenAntD) => CSSProperties = (isSelected, isHovered, tokenAntD) => {
