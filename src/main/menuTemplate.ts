...
function menuTemplate(): MenuItemConstructorOptions[] {
    ...
    return [
        ...
        },
        {
            label: 'View',
            submenu: [
                { label: 'Game World', accelerator: 'CmdOrCtrl+1', click: () => { console.log('..: Game World clicado'); } },
                { label: 'Sprites', accelerator: 'CmdOrCtrl+2', click: () => { console.log('..: Sprites clicado'); } },
                { label: 'Images', accelerator: 'CmdOrCtrl+3', click: () => { console.log('..: Images clicado'); } },
                { label: 'Music', accelerator: 'CmdOrCtrl+4', click: () => { console.log('..: Music clicado'); } },
                { label: 'Sound Effects', accelerator: 'CmdOrCtrl+5', click: () => { console.log('..: Sound Effects clicado'); } },
                { label: 'Palettes', accelerator: 'CmdOrCtrl+6', click: () => { console.log('..: Palettes clicado'); } },
                { label: 'Dialogue Review', accelerator: 'CmdOrCtrl+7', click: () => { console.log('..: Dialogue Review clicado'); } },
                { label: 'Settings', accelerator: 'CmdOrCtrl+8', click: () => { console.log('..: Settings clicado'); } },
                { type: 'separator' },
                {
                    label: 'Theme', submenu: [
