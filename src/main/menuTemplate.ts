    ...
    return [
        ...
        },
        {
            ...
            submenu: [
                ...
                { label: 'Sprites', accelerator: 'CmdOrCtrl+2', click: () => { console.log('..: Sprites clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 2); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Images', accelerator: 'CmdOrCtrl+3', click: () => { console.log('..: Images clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 3); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Music', accelerator: 'CmdOrCtrl+4', click: () => { console.log('..: Music clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 4); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Sound Effects', accelerator: 'CmdOrCtrl+5', click: () => { console.log('..: Sound Effects clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 5); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Palettes', accelerator: 'CmdOrCtrl+6', click: () => { console.log('..: Palettes clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 6); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Dialogue Review', accelerator: 'CmdOrCtrl+7', click: () => { console.log('..: Dialogue Review clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 7); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { label: 'Settings', accelerator: 'CmdOrCtrl+8', click: () => { console.log('..: Settings clicado'); try { if (windows.main && !windows.main.isDestroyed()) windows.main.webContents.send('change-content-view', 8); } catch (e) { console.warn('Failed to send change-content-view', e); } } },
                { type: 'separator' },
                {
                    label: 'Theme', submenu: [
